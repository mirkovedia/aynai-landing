...
/**
 * Sección Cómo funciona — 3 pasos numerados conectados por una línea.
 * Representa el flujo: publicar → intercambiar → ganar reputación.
 */
  ...
  <section id="como-funciona" className="relative bg-cream-200 py-24 sm:py-32">
    <div className="mx-auto max-w-6xl px-5 sm:px-8">
      <SectionHeading
        ...
        title="Conecta. Intercambia. Construye tu reputación."
        description="Tres pasos simples para empezar a transformar lo que sabes en un activo que te pertenece."
      />
