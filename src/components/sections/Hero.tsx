...
export const Hero = () => (
  <section
    id="inicio"
    className="cocoa-glow grain relative overflow-hidden"
  >
    {/* Patrón geométrico andino sutil */}
    <div className="absolute inset-0 text-gold/[0.07]">
      <ChakanaPattern className="h-full w-full" />
    </div>

    {/* Halos de color difusos */}
    <div className="pointer-events-none absolute -left-32 top-20 h-72 w-72 rounded-full bg-red/20 blur-[120px]" />
    <div className="pointer-events-none absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-green/20 blur-[120px]" />
    ...
    <div className="relative mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-5 pb-20 pt-28 text-center sm:px-8">
      <motion.div variants={container} initial="hidden" animate="show">
        ...
        >
          Tu talento vale.
          <br />
          <span className="text-gradient-gold">Demuéstralo.</span>
        </motion.h1>
        ...
        >
          ...
          reputación verificable que nadie puede falsificar.
        </motion.p>
        ...
        >
          <Button as="a" href="#contacto" size="lg" className="group w-full sm:w-auto">
            Empezar gratis
      ...
      >
        {[
          { value: "10–15%", label: "Comisión justa" },
          { value: "100%", label: "Reputación tuya" },
          { value: "0", label: "Bancos requeridos" },
        ].map((stat) => (
